...
void InitGlobalParameter()
{
  ...
  LG::GlobalParameterMgr::GetInstance()->add_parameter<double>("SField:a", 0.5);
  ...
  LG::GlobalParameterMgr::GetInstance()->add_parameter<int>("SField:Type", 0);
  ...
  LG::GlobalParameterMgr::GetInstance()->add_parameter<int>("LFeature:registerMethod", 0);
}
